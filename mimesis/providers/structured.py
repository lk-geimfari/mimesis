...
# TODO: Optimize provider methods
class Structured(BaseProvider):
    ...
    def css(self) -> str:
        ...
        cont_tag = self.random.choice(
            sorted(HTML_CONTAINER_TAGS.keys()),
        )
    ...
    def css_property(self) -> str:
        ...
        """
        prop = self.random.choice(
            sorted(CSS_PROPERTIES.keys()),
        )
    ...
    def html(self) -> str:
        ...
        """
        tag_name = self.random.choice(
            sorted(HTML_CONTAINER_TAGS),
        )
